'''
Codigo reproduzido do video: https://www.youtube.com/watch?v=H4TXHI9BRCQ e cedido pelo autor
adicionando funcionalidades para complementar o codigo desenvolvido anteriormente
'''
